...
export default function DashboardContent() {
  ...
  const recentGenerations = sortedGenerations.slice(0, 5)
    ...
    <div style={{
      ...
      <div style={{ marginBottom: '48px' }}>
        ...
        <p style={{
          ...
          Create stunning carousel posts in seconds
        </p>
      </div>
      ...
      {recentGenerations.length > 0 && (
        <div>
          ...
          <div style={{
            ...
            {recentGenerations.map((gen: any, index: number) => (
              <div
                key={gen.id}
                onClick={() => router.push(`/app/${gen.id}`)}
                style={{
                  padding: '20px',
                  borderBottom: index < recentGenerations.length - 1 ? '1px solid #e5e5e5' : 'none',
                  cursor: 'pointer',
